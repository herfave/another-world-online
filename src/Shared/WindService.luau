...
function WindService.new(setting)
	...
	Object.Velocity = setting.Velocity or Vector3.new(0, 0, 0.45)
	Object.Amount = setting.Amount or 10
	Object.Current = 0
	Object.Frequency = setting.Frequency or 0.5
	Object.Lifetime = setting.Lifetime or 2
	Object.Amplitude = setting.Amplitude or 0.2
	Object.Range = setting.Range or 50
	Object.Part = game.ReplicatedStorage:WaitForChild("Wind")
	Object.Time = setting.Time or nil

    Object.Character = Player.Character or Player.CharacterAdded:Wait()
...
function WindService:GetRandomPosition()
	...
	return Vector3.new(
		self.Character.PrimaryPart.Position.X + RNG:NextInteger(-self.Range, self.Range), 
		self.Character.PrimaryPart.Position.Y + RNG:NextInteger(1, self.Range), -- Replace to: "1, self.Range / 1.5" or see more wind nearby.
		self.Character.PrimaryPart.Position.Z + RNG:NextInteger(-self.Range, self.Range)
	)
end
