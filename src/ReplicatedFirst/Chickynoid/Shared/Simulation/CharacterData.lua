...
function CharacterData:ModuleSetup()
	...
	self:RegisterAnimationName("WallrideR")
	self:RegisterAnimationName("WallrideL")
	self:RegisterAnimationName("WalljumpR")
	self:RegisterAnimationName("WalljumpR")
	self:RegisterAnimationName("Railgrind")
	self:RegisterAnimationName("Land")

	self:RegisterAnimationName("RailTrick1")
	self:RegisterAnimationName("RailTrick2")
	self:RegisterAnimationName("RailTrick3")

	self:RegisterAnimationName("AirTrick1")
	self:RegisterAnimationName("AirTrick2")
	self:RegisterAnimationName("AirTrick3")
		
	self:RegisterAnimationName("GroundTrick1")
	self:RegisterAnimationName("GroundTrick2")
	self:RegisterAnimationName("GroundTrick3")
...
function CharacterData:SmoothPosition(deltaTime, smoothScale)
    if (smoothScale == 1 or smoothScale == 0)  then
        self.serialized.position = self.targetPosition
    else
        self.serialized.position = mathUtils:SmoothLerp(self.serialized.position, self.targetPosition, smoothScale, deltaTime)
    end
end
...
function CharacterData:SetTargetPosition(position, teleport)
...
function CharacterData:GetPosition()
    return self.serialized.position
end
...
function CharacterData:InternalSetAnim(animChannel, animNum)
	...
	if self.serialized[slotString] == 0 then return end
